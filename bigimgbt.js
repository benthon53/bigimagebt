...
(function (factory, window) {
    ...
    L.Control.BigImage = L.Control.extend({
        options: {
            ...
            printControlLabel: '\uD83D\uDDB6',
            printControlClasses: ["bigimage-unicode-icon"],
            printControlTitle: 'Copier la carte',
            _unicodeClass: 'bigimage-unicode-icon',
            maxScale: 10,
            minScale: 1,
            inputTitle: 'Choix échelle :',
        ...
        _createDownloadButton: function () {
            ...
            this._downloadBtn.addEventListener('click', () => {
                ...
                // Fermer automatiquement le panneau après le téléchargement
        ...
        _print: function () {
            ...
            promise.then(() => {
                ...
                self.canvas.toBlob(function (blob) {
                    ...
                    link.download = "Votre_Carte_Num.png";
